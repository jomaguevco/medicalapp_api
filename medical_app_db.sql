-- =====================================================================
--  MedicalApp - Esquema de base de datos
--  Motor: MySQL / MariaDB  (phpMyAdmin)
--
--  COMO USAR:
--    1. Abrir phpMyAdmin en el navegador (http://localhost/phpmyadmin)
--    2. Ir a la pestaña "SQL"
--    3. Pegar TODO este archivo y ejecutar (Continuar)
--
--  El nombre de la BD (medical_app_db) coincide con config.py -> DB_NAME
--  Todas las contrasenas de prueba son:  usat
-- =====================================================================
